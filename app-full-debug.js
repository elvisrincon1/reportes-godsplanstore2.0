// Combined full code for the Reportar Ventas app with debug logs for review and correction
...
function loadData(key) {
  ...
  if (data) {
    try {
      ...
      console.log(`Datos cargados correctamente para ${key}:`, parsedData);
      return parsedData;
    } catch (error) {
      console.error(`Error al analizar los datos para ${key}:`, error);
      return [];
    }
  }
  console.log(`No se encontraron datos para ${key}, devolviendo un array vacío.`);
  return [];
}
...
document.addEventListener('DOMContentLoaded', () => {
  loadSellers();
  console.log('Vendedores Cargados:', sellers);
  loadAffiliates();
  console.log('Afiliados Cargados:', affiliates);
  loadProducts();
